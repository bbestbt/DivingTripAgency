...
class _editHotelFormState extends State<editHotelForm> {
  ...
  void sendUpdateHotel() async {
    ...
    hotel.address.addressLine1 = eachHotel.address.addressLine1;
    hotel.address.addressLine2 = eachHotel.address.addressLine2;
    hotel.address.postcode = eachHotel.address.postcode;
    hotel.address.city = eachHotel.address.city;
    hotel.address.country = eachHotel.address.country;
    hotel.address.region = eachHotel.address.region;
