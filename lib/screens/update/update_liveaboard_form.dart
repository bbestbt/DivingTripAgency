...
class _editLiveaboardFormState extends State<editLiveaboardForm> {
  ...
  _getliveaboard(int num) async {
    ...
    if (lvb != null) {
      setState(() {
        if (num == 1) {liveaboardimg = io.File(lvb.path); liveX1 = lvb;}
        if (num == 2) {liveaboardimg2 = io.File(lvb.path);liveX2 = lvb;}
        if (num == 3) {liveaboardimg3 = io.File(lvb.path);liveX3 = lvb;}
        if (num == 4) {liveaboardimg4 = io.File(lvb.path);liveX4 = lvb;}
        if (num == 5) {liveaboardimg5 = io.File(lvb.path);liveX5 = lvb;}
        if (num == 6) {liveaboardimg6 = io.File(lvb.path);liveX6 = lvb;}
        if (num == 7) {liveaboardimg7 = io.File(lvb.path);liveX7 = lvb;}
        if (num == 8) {liveaboardimg8 = io.File(lvb.path);liveX8 = lvb;}
        if (num == 9) {liveaboardimg9 = io.File(lvb.path);liveX9 = lvb;}
        if (num == 10) {liveaboardimg10 = io.File(lvb.path);liveX10 = lvb;}
